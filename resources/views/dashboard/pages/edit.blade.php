...
<div class="mt-3 card">
    <div class="card-body">
        <form method="POST" action="{{ route('pages.update', ['page' => $page->slug]) }}">
            @csrf
            @method('PUT')
            <div class="mb-3 row">
                ...
                <div class="col-sm-12 col-lg-6">
                    <div class="form-group">
                        ...
                        <input class="form-control @error('slug')
                            is-invalid
                            @enderror " type="text" name="slug" id="slug" value="{{ old('slug', $page->slug) }}"
            ...
            <div class="mb-3">
                <div class="form-group">
                    ...
                    <textarea id="body" name="body"
                        class="form-control @error('body') is-invalid @enderror">{!! old('body', $page->body) !!}</textarea>
            ...
            <div class="mb-3">
                <div class="form-group">
                    ...
                    <select class="form-control @error('location') is-invalid @enderror" name="location" id="location">
                        <option value="" disabled {{ old('location', $page->location) == null ? 'selected' : ''
                            }}>Choose...</option>
                        <option value="header" {{ old('location', $page->location) == 'header' ? 'selected' : ''
                            }}>Header</option>
                        <option value="footer" {{ old('location', $page->location) == 'footer' ? 'selected' : ''
                            }}>Footer</option>
                        <option value="both" {{ old('location', $page->location) == 'both' ? 'selected' : '' }}>Both
                        </option>
                    </select>
            ...
            <div class="mb-3">
                <div class="form-group">
                    ...
                    <div class="form-check form-switch form-switch-md float-end">
                        <input id="publish" class="form-check-input" {{ $page->status === 'publish' ? 'checked=""' : '' }} value="publish" name="status"
                            type="checkbox">
                    </div>
