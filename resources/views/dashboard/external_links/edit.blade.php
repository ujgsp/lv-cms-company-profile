            ...
            <div class="mb-3">
                <div class="form-group">
                    ...
                    <input class="form-control @error('title') is-invalid @enderror" type="text" name="title" id="title"
                        placeholder="My New Link" value="{{ old('title', $link->title) }}">
            ...
            <div class="mb-3">
                <div class="form-group">
                    ...
                    <input class="form-control @error('location') is-invalid @enderror" type="text" name="location"
                        id="location" placeholder="https://example.com/page" value="{{ old('location', $link->location) }}">
            ...
            <div class="mb-3">
                <div class="form-group">
                    ...
                    <select class="form-select @error('placement') is-invalid @enderror" name="placement">
                        <option value="both" {{ old('placement', $link->placement) == 'both' ? 'selected' : '' }}>Both</option>
                        <option value="header" {{ old('placement', $link->placement) == 'header' ? 'selected' : '' }}>Header</option>
                        <option value="footer" {{ old('placement', $link->placement) == 'footer' ? 'selected' : '' }}>Footer</option>
                    </select>
            ...
            <div class="mb-3">
                <div class="form-group">
                    ...
                    <div class="form-check form-switch form-switch-md float-end">
                        <input class="form-check-input" id="newTab" value="true" name="newTab" type="checkbox" {{ old('newTab', $link->new_tab) ? 'checked' : '' }}>
                    </div>
