        ...
        <form method="POST" action="{{ route('members.update', $member) }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <div class="form-group">
                    ...
                    <input class="form-control @error('designation') is-invalid @enderror" type="text" name="designation" id="designation"
                        placeholder="Enter designation" value="{{ old('designation',$member->designation) }}">
            ...
            <div class="mb-3">
                <div class="form-group">
                    ...
                    <input class="form-control @error('facebook') is-invalid @enderror" type="text" name="facebook" id="facebook"
                        placeholder="Enter facebook" value="{{ old('facebook', $member->facebook_url) }}">

                    <small class="text-muted mt-3">e.g. <span class="text-danger">https://facebook.com/janesmith</span></small>
            ...
            <div class="mb-3">
                <div class="form-group">
                    ...
                    <input class="form-control @error('instagram') is-invalid @enderror" type="text" name="instagram" id="instagram"
                        placeholder="Enter instagram" value="{{ old('instagram', $member->instagram_url) }}">
            ...
            <div class="mb-3">
                <div class="form-group">
                    ...
                    <input class="form-control @error('twitter') is-invalid @enderror" type="text" name="twitter" id="twitter"
                        placeholder="Enter twitter" value="{{ old('twitter', $member->twitter_url) }}">
            ...
            <div class="mb-3">
                <div class="form-group">
                    ...
                    <input class="form-control @error('linkedin') is-invalid @enderror" type="text" name="linkedin" id="linkedin"
                        placeholder="Enter linkedin" value="{{ old('linkedin', $member->linkedin_url) }}">
            ...
            <div class="mb-3">
                <div class="form-group">
                    ...
                    <input class="form-control @error('phone') is-invalid @enderror" type="text" name="phone" id="phone"
                        placeholder="Enter phone" value="{{ old('phone', $member->phone) }}">
            ...
            <div class="mb-3">
                <div class="form-group">
                    ...
                    <div class="form-check form-switch form-switch-md float-end">
                        <input id="publish" class="form-check-input" {{ $member->status === 'enable' ? 'checked=""' : '' }} value="enable" name="status" type="checkbox">
                    </div>
