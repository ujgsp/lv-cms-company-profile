                ...
                <div class="mb-3">
                    <div class="form-group">
                        ...
                        <input class="form-control @error('text_primary') is-invalid @enderror" type="text"
                            ...
                            value="{{ old('text_primary', $slider->text_primary) }}">
                ...
                <div class="mb-3">
                    <div class="form-group">
                        ...
                        <input class="form-control @error('text_secondary') is-invalid @enderror" type="text"
                            ...
                            value="{{ old('text_secondary', $slider->text_secondary) }}">
                ...
                <div class="mb-3">
                    ...
                    @if ($slider->thumbnail)
                        <div class="image-preview">
                            <img src="{{ asset('storage/' . $slider->thumbnail) }}" alt="{{ $slider->text_primary }}"
                                id="previewImage">
                        </div>
                    @endif
                ...
                <div class="mb-3">
                    <div class="form-group">
                        ...
                        <input class="form-control @error('button_title') is-invalid @enderror" type="text"
                            name="button_title" id="button_title" placeholder="Enter title"
                            value="{{ old('button_title', $slider->btn_title) }}">
                ...
                <div class="mb-3">
                    <div class="form-group">
                        ...
                        <input class="form-control @error('button_link') is-invalid @enderror" type="text"
                            ...
                            value="{{ old('button_link', $slider->btn_link) }}">
