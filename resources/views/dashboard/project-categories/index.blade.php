...
<div class="tld-search-area">
    <div class="input-group tld-search-sec">
        <form class="row g-1" method="GET" action="{{ route('projectCategories.index') }}">
            <div class="col-auto">
    ...
    <a href="{{ route('projectCategories.create') }}" class="mr-2 btn btn-primary">
    ...
    <table class="table my-0 table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('projectCategories.edit', ['projectCategory' => $category]) }}"
                        class="btn btn-sm btn-primary"><i class="align-middle" data-feather="edit-2"></i>
                        <span class="align-middle"> Edit</a>
                    <form action="{{ route('projectCategories.destroy', ['projectCategory' => $category]) }}" method="post"
                        class="d-inline">
                        @method('delete')
                        @csrf
            ...
            @empty
            <tr>
                <td colspan="6">No Project Categories Found...</td>
            </tr>
            @endforelse
